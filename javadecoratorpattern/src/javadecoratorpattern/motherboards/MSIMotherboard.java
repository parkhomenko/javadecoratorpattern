 ...
 * Concrete decorator
 */
public class MSIMotherboard extends Decorator {
    
    public MSIMotherboard(Detail detail) {
        super(detail);
    }
    ...
    public String getDescription() {
        return super.getDescription() + ", MSI Motherboard";
    }
