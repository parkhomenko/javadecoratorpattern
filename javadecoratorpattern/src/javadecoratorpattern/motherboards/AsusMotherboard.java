 ...
 * Concrete decorator
 */
public class AsusMotherboard extends Decorator {
    
    public AsusMotherboard(Detail detail) {
        super(detail);
    }
    ...
    public String getDescription() {
        return super.getDescription() + ", Asus Motherboard";
    }
