package javadecoratorpattern.memory;
 ...
 * Concrete decorator
 */
public class Kingston4Gb extends Decorator {
    
    public Kingston4Gb(Detail detail) {
        super(detail);
    }
    ...
    public String getDescription() {
        return super.getDescription() + ", Kingston 4Gb Memory";
    }
